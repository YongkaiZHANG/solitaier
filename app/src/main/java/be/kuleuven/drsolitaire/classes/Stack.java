...
public class Stack {
    ...
    private int id;                                                                                 //id: 0 to 6 tableau. 7 to 10 foundations. 11,12,13 for talon, 14 voor pile
    ...
    /**
     * Returns the card on the top of the stack, de eerste van onder te tellen
     *
    ...
    /**
     * @return the first card which is faced up. De eerste zichtbare kaart, van boven te tellen
     */
