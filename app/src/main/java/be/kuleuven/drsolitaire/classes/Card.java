...
import static be.kuleuven.drsolitaire.SharedData.DEFAULT_4_COLOR_MODE;
import static be.kuleuven.drsolitaire.SharedData.DEFAULT_CARD_BACKGROUND;
import static be.kuleuven.drsolitaire.SharedData.DEFAULT_CARD_BACKGROUND_COLOR;
import static be.kuleuven.drsolitaire.SharedData.ERROR;
...
import static be.kuleuven.drsolitaire.SharedData.bitmaps;
import static be.kuleuven.drsolitaire.SharedData.cards;
...
import static be.kuleuven.drsolitaire.SharedData.saveErrorCount;
...
public class Card {
    ...
    public String toString() {
        String suitName = SUIT.values()[color-1].toString();
